...
function WDTowerFiles(props) {
  ...
  const {wdVersion, loading, wdTowerFile} = useSelector(s => s.designModule);

  const towerFiles = wdTowerFile?.working_drawing_tower_files || [];
