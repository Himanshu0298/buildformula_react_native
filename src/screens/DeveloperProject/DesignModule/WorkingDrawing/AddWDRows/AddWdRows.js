...
function AddWDRows(props) {
  ...
  const {getWDTower, AddWDRow, updateWDRow, deleteWDRow, rearrangeFloorRows} =
    useDesignModuleActions();

  const {wdTowerFile, loading} = useSelector(s => s.designModule);
